...
<head>
    ...
    <title>Edit Store Location - <?php echo APP_NAME; ?></title>
    <?php if (APP_FAVICON): ?>
            ...
            <form method="POST">
                <div class="form-group">
                    ...
                    <select id="chain_id" name="chain_id" required>
                        ...
                        <?php while ($chain = $chains->fetch(PDO::FETCH_ASSOC)): ?>
                            <option value="<?php echo $chain['id']; ?>" <?php echo ($storeLocation->chain_id == $chain['id']) ? 'selected' : ''; ?>>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="location_name" name="location_name"
                           ...
                           value="<?php echo htmlspecialchars($storeLocation->location_name ?? ''); ?>">
                ...
                <div class="form-group">
                    ...
                    <textarea id="address" name="address" rows="3" 
                              placeholder="Complete street address"><?php echo htmlspecialchars($storeLocation->address ?? ''); ?></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="phone" name="phone" 
                           ...
                           value="<?php echo htmlspecialchars($storeLocation->phone ?? ''); ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="hours" name="hours" 
                           ...
                           value="<?php echo htmlspecialchars($storeLocation->hours ?? ''); ?>">
                </div>

                <div class="form-group">
                    <label for="notes">Notes</label>
                    <textarea id="notes" name="notes" rows="3" 
                              placeholder="Additional notes about this location"><?php echo htmlspecialchars($storeLocation->notes ?? ''); ?></textarea>
                </div>

                <div class="form-group">
                    <label>
                        <input type="checkbox" name="is_active" <?php echo $storeLocation->is_active ? 'checked' : ''; ?>> Active
                    </label>
                </div>
                ...
                <div style="display: flex; gap: 1rem; margin-top: 2rem; align-items: center;">
                    ...
                    <?php if(!$storeLocation->is_active): ?>
                        <a href="index.php?action=delete_store_location&id=<?php echo $storeLocation->id; ?>" 
                           class="btn btn-danger" 
                           onclick="return confirm('Permanently delete this location? This cannot be undone.');" 
                           style="margin-left: auto;">
                            🗑️ Delete Location
                        </a>
                    <?php else: ?>
                        <span style="margin-left: auto; color: #888; font-size: 0.9em;">💡 Deactivate to enable deletion</span>
                    <?php endif; ?>
                </div>
            </form>
        </div>
