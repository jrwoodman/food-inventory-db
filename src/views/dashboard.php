                                    ...
                                    <div style="display: flex; justify-content: space-between; align-items: start; gap: 1rem;">
                                        <div style="flex: 1;">
                                            ...
                                            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 0.5rem; font-size: 0.875rem; color: #b5bac1;">
                                                <div>
                                                    <span style="color: #BBBBBB;">📍 Location:</span> <?php echo htmlspecialchars($result['location'] ?? 'N/A'); ?>
                                                </div>
                                                <div>
                                                    <span style="color: #BBBBBB;">📦 Quantity:</span> <?php echo htmlspecialchars($result['quantity'] ?? '0'); ?> <?php echo htmlspecialchars($result['unit'] ?? ''); ?>
                                                </div>
                                                <?php if (!empty($result['category'])): ?>
                                                <div>
                                                    <span style="color: #BBBBBB;">🏷️ Category:</span> <?php echo htmlspecialchars($result['category']); ?>
                                                </div>
                                                <?php endif; ?>
                                                <?php if (!empty($result['expiry_date'])): ?>
                                                <div>
                                                    <span style="color: #BBBBBB;">📅 Expires:</span> <?php echo date('M j, Y', strtotime($result['expiry_date'])); ?>
                                                </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
