...
<body>
                ...
                <form method="POST" class="add-form">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="bulk_supplier" name="supplier" placeholder="Store or supplier name">
                        </div>
                    </div>
    ...
    <script>
        ...
        function searchExistingIngredients() {
            ...
            fetch(`index.php?action=search_ingredients&q=${encodeURIComponent(query)}&group_id=${groupId}`)
        ...
        nameInput.addEventListener('input', function() {
            ...
            searchTimeout = setTimeout(searchExistingIngredients, 300);
        });
